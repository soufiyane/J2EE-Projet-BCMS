...
public class BCMS extends Timer_monitor implements FSC, PSC {
    ...
    private void init_behavior() throws Statechart_exception {
        ...
        _bCMS_state_machine = new Statechart_monitor(_Init.xor(_FSC_connected).xor(_PSC_connected).xor(_Crisis_details_exchange).xor(_Step_3_Coordination).xor(_Step_4_Dispatching).xor(_All_fire_trucks_dispatched).xor(_All_police_vehicles_dispatched).xor(_Step_5_Arrival).xor(_Completion_of_objectives).xor(_End_of_crisis), this.getClass().getSimpleName(), AbstractStatechart_monitor.Show_on_system_out, null);
    }
    ...
    public void FSC_connection_request() throws Statechart_exception {
        ...
        managed.createEvent(_FSC_connection_request, _bCMS_state_machine.current_state(), "FSC");
    }
    ...
    public void PSC_connection_request() throws Statechart_exception {
        ...
        managed.createEvent(_PSC_connection_request, _bCMS_state_machine.current_state(), "PSC");
    }
    ...
    public void state_fire_truck_number(int number_of_fire_truck_required) throws Statechart_exception {
        ...
        managed.createEvent(_State_fire_truck_number, _bCMS_state_machine.current_state(), "FSC");
        managed.setNbFireTruck(number_of_fire_truck_required);
    }
    ...
    public void state_police_vehicle_number(int number_of_police_vehicle_required) throws Statechart_exception {
        ...
        managed.createEvent(_State_police_vehicle_number, _bCMS_state_machine.current_state(), "PSC");
        managed.setNbPoliceVehicule(number_of_police_vehicle_required);
    ...
    public void route_for_fire_trucks(String route_name) throws Statechart_exception {
        ...
        _last_fire_truck_route = managed.getRoute(route_name);// On construit un entity bean 'Route' avec sa clef 'route_name' ; on le cherche dans la base...
        if (_last_fire_truck_route != null) {
            _bCMS_state_machine.run_to_completion(_Route_for_fire_trucks);
            managed.createEvent(_Route_for_fire_trucks, _bCMS_state_machine.current_state(), "FSC");
        } else {
    ...
    public void route_for_police_vehicles(String route_name) throws Statechart_exception {
        ...
        _last_police_vehicle_route = managed.getRoute(route_name); // On construit un entity bean 'Route' avec sa clef 'route_name' ; on le cherche dans la base...
        if (_last_police_vehicle_route != null) {
            _bCMS_state_machine.run_to_completion(_Route_for_police_vehicles);
            managed.createEvent(_Route_for_police_vehicles, _bCMS_state_machine.current_state(), "PSC");
        } else {
    ...
    public void FSC_agrees_about_fire_truck_route() throws Statechart_exception {
        ...
        managed.createEvent(_FSC_agrees_about_fire_truck_route, _bCMS_state_machine.current_state(), "FSC");
    ...
    public void FSC_agrees_about_police_vehicle_route() throws Statechart_exception {
        _bCMS_state_machine.run_to_completion(_FSC_agrees_about_police_vehicle_route);
         managed.createEvent(_FSC_agrees_about_police_vehicle_route, _bCMS_state_machine.current_state(), "FSC");
    ...
    public void FSC_disagrees_about_fire_truck_route() throws Statechart_exception {
        ...
        managed.createEvent(_FSC_disagrees_about_fire_truck_route, _bCMS_state_machine.current_state(), "FSC");
    ...
    public void FSC_disagrees_about_police_vehicle_route() throws Statechart_exception {
        ...
        managed.createEvent(_FSC_disagrees_about_police_vehicle_route, _bCMS_state_machine.current_state(), "FSC");
    ...
    public void enough_fire_trucks_dispatched() throws Statechart_exception {
        ...
        managed.createEvent(_Enough_fire_trucks_dispatched, _bCMS_state_machine.current_state(), "FSC");
    ...
    public void fire_truck_dispatched(String fire_truck) throws Statechart_exception {
        ...
        ft = managed.getFireTruck(fire_truck);
        if (ft != null) {
            ...
            bcmsft = managed.getBcmsSessionFireTruckByFireTruckName(ft.getFireTruckName());
            managed.setFireTruckStatus(bcmsft, "Dispatched");
            managed.createEvent(_Fire_truck_dispatched, _bCMS_state_machine.current_state(), "FSC");
        }
    }
    ...
    public void enough_police_vehicles_dispatched() throws Statechart_exception {
        ...
        managed.createEvent(_Enough_police_vehicles_dispatched, _bCMS_state_machine.current_state(), "PSC");
    ...
    public void police_vehicle_dispatched(String police_vehicle) throws Statechart_exception {
        ...
        pv = managed.getPoliceVehicule(police_vehicle);
        if (pv != null) {
            ...
            bcmspv = managed.getBcmsSessionPoliceVehicleByPoliceVehicleName(pv.getPoliceVehicleName());
            managed.setPoliceVehicleStatus(bcmspv, "Dispatched");
            managed.createEvent(_Police_vehicle_dispatched, _bCMS_state_machine.current_state(), "PSC");
        }
    }
    ...
    public void enough_fire_trucks_arrived() throws Statechart_exception {
        ...
        managed.createEvent(_Enough_fire_trucks_arrived, _bCMS_state_machine.current_state(), "FSC");
    ...
    public void fire_truck_arrived(String fire_truck) throws Statechart_exception {
        ...
        if (ft != null) {
            ...
            BcmsSessionFireTruck bcmsft = new BcmsSessionFireTruck();
            bcmsft = managed.getBcmsSessionFireTruckByFireTruckName(ft.getFireTruckName());
            managed.setFireTruckStatus(bcmsft, "Arrived");
            managed.createEvent(_Fire_truck_arrived, _bCMS_state_machine.current_state(), "FSC");
        }
    ...
    public void enough_police_vehicles_arrived() throws Statechart_exception {
        ...
        managed.createEvent(_Enough_fire_trucks_arrived, _bCMS_state_machine.current_state(), "PSC");
    ...
    public void police_vehicle_arrived(String police_vehicle) throws Statechart_exception {
        ...
        if (pv != null) {
            ...
            BcmsSessionPoliceVehicle bcmspv = new BcmsSessionPoliceVehicle();
            bcmspv = managed.getBcmsSessionPoliceVehicleByPoliceVehicleName(pv.getPoliceVehicleName());
            managed.setPoliceVehicleStatus(bcmspv, "Arrived");
            managed.createEvent(_Police_vehicle_dispatched, _bCMS_state_machine.current_state(), "PSC");
        }
    }
    ...
    public void fire_truck_breakdown(String fire_truck,/* may be 'null' */ String replacement_fire_truck) throws Statechart_exception {
        ...
        if (ft != null) {            
            BcmsSessionFireTruck bcmsft = new BcmsSessionFireTruck();
            bcmsft = managed.getBcmsSessionFireTruckByFireTruckName(ft.getFireTruckName());
            managed.setFireTruckStatus(bcmsft, "Breakdown");
            managed.createEvent(_Fire_truck_breakdown, _bCMS_state_machine.current_state(), "FSC");
        }
    ...
    public void police_vehicle_breakdown(String police_vehicle,/* may be 'null' */ String replacement_police_vehicle) throws Statechart_exception {
        ...
        if (pv != null) {            
            BcmsSessionPoliceVehicle bcmspv = new BcmsSessionPoliceVehicle();
            bcmspv = managed.getBcmsSessionPoliceVehicleByPoliceVehicleName(pv.getPoliceVehicleName());
            managed.setPoliceVehicleStatus(bcmspv, "Breakdown");
            managed.createEvent(_Police_vehicle_breakdown, _bCMS_state_machine.current_state(), "PSC");
        }
    ...
    public void fire_truck_blocked(String fire_truck) throws Statechart_exception {
        ...
        if (ft != null) {
            ...
            BcmsSessionFireTruck bcmsft = new BcmsSessionFireTruck();
            bcmsft = managed.getBcmsSessionFireTruckByFireTruckName(ft.getFireTruckName());
            managed.setFireTruckStatus(bcmsft, "Blocked");
            managed.createEvent(_Fire_truck_blocked, _bCMS_state_machine.current_state(), "FSC");
        }
    ...
    public void police_vehicle_blocked(String police_vehicle) throws Statechart_exception {
        ...
        if (pv != null) {
            ...
            BcmsSessionPoliceVehicle bcmspv = new BcmsSessionPoliceVehicle();
            bcmspv = managed.getBcmsSessionPoliceVehicleByPoliceVehicleName(pv.getPoliceVehicleName());
            managed.setPoliceVehicleStatus(bcmspv, "Blocked");
            managed.createEvent(_Police_vehicle_blocked, _bCMS_state_machine.current_state(), "PSC");
        }
    ...
    public void crisis_is_more_severe() throws Statechart_exception {
      ...
      managed.createEvent(_Crisis_is_more_severe, _bCMS_state_machine.current_state(), "PSC/FSC");
    ...
    public void crisis_is_less_severe() throws Statechart_exception {
        ...
        managed.createEvent(_Crisis_is_less_severe, _bCMS_state_machine.current_state(), "PSC/FSC");
    ...
    public void no_more_route_left() throws Statechart_exception {
        ...
        managed.createEvent(_No_more_route_left, _bCMS_state_machine.current_state(), "PSC");
